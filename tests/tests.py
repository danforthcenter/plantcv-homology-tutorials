...
inputs_list = [
    [project_root, 'acute_plm_tutorial_1.ipynb'],
    [project_root, 'acute_plm_tutorial_2.ipynb'],
    [project_root, 'acute_plm_tutorial_3.ipynb'],
    [project_root, 'acute_plm_tutorial_4.ipynb']
]
